...
public final class QueryProtocol {
  ...
  public enum DataType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.qasr.protocol.QueryProtocol.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public interface QueryOrBuilder
    ...
    java.util.List<com.qasr.protocol.QueryProtocol.DataType> getTypeList();
    int getTypeCount();
    com.qasr.protocol.QueryProtocol.DataType getType(int index);
  ...
  public static final class Query extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.qasr.protocol.QueryProtocol.internal_static_Query_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.qasr.protocol.QueryProtocol.internal_static_Query_fieldAccessorTable;
    }
    ...
    private java.util.List<com.qasr.protocol.QueryProtocol.DataType> type_;
    public java.util.List<com.qasr.protocol.QueryProtocol.DataType> getTypeList() {
      return type_;
    }
    public int getTypeCount() {
      return type_.size();
    }
    public com.qasr.protocol.QueryProtocol.DataType getType(int index) {
    ...
    public static com.qasr.protocol.QueryProtocol.Query parseFrom(
    ...
    public static com.qasr.protocol.QueryProtocol.Query parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.qasr.protocol.QueryProtocol.Query parseFrom(
    ...
    public static com.qasr.protocol.QueryProtocol.Query parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.qasr.protocol.QueryProtocol.Query parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.qasr.protocol.QueryProtocol.Query parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.qasr.protocol.QueryProtocol.Query prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.qasr.protocol.QueryProtocol.QueryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.qasr.protocol.QueryProtocol.internal_static_Query_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.qasr.protocol.QueryProtocol.Query.getDescriptor();
      }
      
      public com.qasr.protocol.QueryProtocol.Query getDefaultInstanceForType() {
        return com.qasr.protocol.QueryProtocol.Query.getDefaultInstance();
      }
      
      public com.qasr.protocol.QueryProtocol.Query build() {
        com.qasr.protocol.QueryProtocol.Query result = buildPartial();
      ...
      private com.qasr.protocol.QueryProtocol.Query buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.qasr.protocol.QueryProtocol.Query result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.qasr.protocol.QueryProtocol.Query buildPartial() {
        com.qasr.protocol.QueryProtocol.Query result = new com.qasr.protocol.QueryProtocol.Query(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.qasr.protocol.QueryProtocol.Query) {
          return mergeFrom((com.qasr.protocol.QueryProtocol.Query)other);
        } else {
      ...
      public Builder mergeFrom(com.qasr.protocol.QueryProtocol.Query other) {
        if (other == com.qasr.protocol.QueryProtocol.Query.getDefaultInstance()) return this;
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              com.qasr.protocol.QueryProtocol.DataType value = com.qasr.protocol.QueryProtocol.DataType.valueOf(rawValue);
              if (value == null) {
  ...
  ensureValueIsMutable();
      ...
      private void ensureTypeIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          type_ = new java.util.ArrayList<com.qasr.protocol.QueryProtocol.DataType>(type_);
      ...
      public Builder setType(
          int index, com.qasr.protocol.QueryProtocol.DataType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureTypeIsMutable();
      ...
      public Builder addType(com.qasr.protocol.QueryProtocol.DataType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureTypeIsMutable();
      ...
      public Builder addAllType(
          java.lang.Iterable<? extends com.qasr.protocol.QueryProtocol.DataType> values) {
        ensureTypeIsMutable();
  ...
  public static final class Response extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.qasr.protocol.QueryProtocol.internal_static_Response_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.qasr.protocol.QueryProtocol.internal_static_Response_fieldAccessorTable;
    }
    ...
    public static com.qasr.protocol.QueryProtocol.Response parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.qasr.protocol.QueryProtocol.Response parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.qasr.protocol.QueryProtocol.Response parseFrom(
    ...
    public static com.qasr.protocol.QueryProtocol.Response parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.qasr.protocol.QueryProtocol.Response parseFrom(
    ...
    public static com.qasr.protocol.QueryProtocol.Response parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.qasr.protocol.QueryProtocol.Response parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.qasr.protocol.QueryProtocol.Response prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.qasr.protocol.QueryProtocol.ResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.qasr.protocol.QueryProtocol.internal_static_Response_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.qasr.protocol.QueryProtocol.Response.getDescriptor();
      }
      
      public com.qasr.protocol.QueryProtocol.Response getDefaultInstanceForType() {
        return com.qasr.protocol.QueryProtocol.Response.getDefaultInstance();
      }
      
      public com.qasr.protocol.QueryProtocol.Response build() {
        com.qasr.protocol.QueryProtocol.Response result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.qasr.protocol.QueryProtocol.Response buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.qasr.protocol.QueryProtocol.Response result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.qasr.protocol.QueryProtocol.Response buildPartial() {
        com.qasr.protocol.QueryProtocol.Response result = new com.qasr.protocol.QueryProtocol.Response(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.qasr.protocol.QueryProtocol.Response) {
          return mergeFrom((com.qasr.protocol.QueryProtocol.Response)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.qasr.protocol.QueryProtocol.Response other) {
        if (other == com.qasr.protocol.QueryProtocol.Response.getDefaultInstance()) return this;
        if (other.hasCode()) {
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_Query_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.qasr.protocol.QueryProtocol.Query.class,
              com.qasr.protocol.QueryProtocol.Query.Builder.class);
          internal_static_Response_descriptor =
          ...
          internal_static_Response_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.qasr.protocol.QueryProtocol.Response.class,
              com.qasr.protocol.QueryProtocol.Response.Builder.class);
          return null;
        }
      };
